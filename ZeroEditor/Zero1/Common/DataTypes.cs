...
namespace ZeroEditor.Zero1.DataType
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    [DebuggerDisplay("FLY dmg={dmg} hit_rng={hit_rng} mdl={mdl_no} cond={cond}")]
    public struct FLY_DATA
    {
        public ushort dmg;      // 0x00
        public ushort hit_rng;  // 0x02
        public ushort mdl_no;   // 0x04
        public ushort cond;     // 0x06
    }
